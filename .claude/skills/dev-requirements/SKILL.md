...
実行可能仕様駆動開発の考え方に基づき、実装前に仕様・契約を確定させることがゴール。
...
│             ↓ 調査サマリーを受け取る
├── Step3: 実行可能な仕様生成 → general-purpose エージェント
│             ↓ 生成ファイル一覧を受け取る
├── Step4: ドキュメント更新（メイン）
...
### Step 3: 実行可能な仕様生成（general-purpose エージェント）
...
```
以下の調査サマリーとissue内容をもとに、実行可能な仕様を生成してください。
[調査サマリー]
[issue内容]
